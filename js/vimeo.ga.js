...
(function($) {
  ...
  function sendEvent(action) {
    switch (gaTracker) {
    case 'gtm':
      dataLayer.push({'event': 'Vimeo', 'eventCategory': 'Vimeo', 'eventAction': action, 'eventLabel': url, 'eventValue': undefined, 'eventNonInteraction': true});
      break;

    case 'ua':
      ga('send', 'event', 'Vimeo', action, url, undefined, {'nonInteraction': 1});
      break;
  ...
  function onMessageReceived(e) {
    ...
    case 'seek':
      if (trackSeeking && !videoSeeking) {
        ...
        videoStatus.text('Skipped video forward or backward');
      }
      break;
    ...
    case 'finish':
      if (!videoCompleted) {
        ...
        videoStatus.text('Completed video');
      }
      break;
    }
  }
  ...
  function onReady() {
    ...
    videoStatus.text('Ready to track events');
  }
