...
$(function() {
    ...
    function onMessageReceived(e) {
        ...
        case 'seek':
            if (trackSeeking && !videoSeeking) {
                ...
                videoStatus.html('Last tracked event: <strong>Skipped video</strong>');
            }
            break;
        ...
        case 'play':
            if (!videoPlayed) {
                ...
                videoStatus.html('Last tracked event: <strong>Started video</strong>');
        ...
        case 'finish':
            if (!videoCompleted) {
                ...
                videoStatus.html('Last tracked event: <strong>Completed video</strong>');
    ...
    function onPause() {
     if (timePercentComplete < 99 && !videoPaused) {
      ...
      videoStatus.html('Last tracked event: <strong>Paused video</strong>');
    ...
    function onPlayProgress(data) {
        ...
        if (progress) {
            ...
            videoStatus.html('Last tracked event: <strong>'+progress+'</strong>');
        }
    }
